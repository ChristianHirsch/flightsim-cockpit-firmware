 ...
 */
#define USB_CFG_VENDOR_NAME     'g','i','t','h','u','b','.','c','o','m','/','C','h','r','i','s','t','i','a','n','H','i','r','s','c','h'
#define USB_CFG_VENDOR_NAME_LEN 26
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'f','l','i','g','h','t','s','i','m','-','c','o','c','k','p','i','t'
